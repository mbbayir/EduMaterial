    ...
    public partial class mig01 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryCourses", x => new { x.CategoryId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseProducers", x => new { x.CourseId, x.ProducerId });
                    table.ForeignKey(
                        name: "FK_CourseProducers_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseProducers_Producers_ProducerId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "01426673-993d-4ed6-acfe-ab771e42a457", 0, "210384bb-407d-4d12-ad44-f550357091bd", "admin@example.com", true, "Admin", false, null, "ADMIN@EXAMPLE.COM", "ADMIN@EXAMPLE.COM", "AQAAAAIAAYagAAAAEBzJAxKUbMT3tXelL81+z2ZiAfeG/CqJQbUO1gk+ZlX54yd8qXQgL0fQ8Wj4ywo6iQ==", null, false, "", false, "admin@example.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseProducers_ProducerId",
                table: "CourseProducers",
                column: "ProducerId");
